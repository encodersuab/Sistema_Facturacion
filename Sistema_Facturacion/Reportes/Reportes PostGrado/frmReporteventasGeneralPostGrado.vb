Public Class frmReporteventasGeneralPostGrado
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Me.mostrar_venta_porFecha_postgrado_generalTableAdapter.Fill(Me.dbfacDataSet.mostrar_venta_porFecha_postgrado_general, dtpFechaInicio.Value, dtpFechaFin.Value)
