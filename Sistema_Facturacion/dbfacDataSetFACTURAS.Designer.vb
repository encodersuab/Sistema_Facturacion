...
Partial Public Class dbfacDataSetFACTURAS
    ...
    Partial Public Class mostrar_factura3DataTable
        ...
        Public Overloads Function Addmostrar_factura3Row( _
            ...
            Dim columnValuesArray() As Object = New Object() {Nothing, Fecha_emision, Nit_Emisor, Total, Codigo_Control, Ci_Nit_Comprador, imagen, cantidad, NombreProducto, precio_unitario, TotalParcial, nombre_fac, tipo_documento, Num_Autorizacion, descripcion, medida, literal, Fecha_limite, ncuota, nombre_categoria, Nothing}
    ...
    Partial Public Class mostrar_factura3Row
        ...
        Public Property idproducto() As Integer
            Get
                Return CType(Me(Me.tablemostrar_factura3.idproductoColumn), Integer)
            End Get
            Set(value As Integer)
                Me(Me.tablemostrar_factura3.idproductoColumn) = value
            End Set
        End Property
