...
Public Class CrystalReportSF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Facturacion.CrystalReportSF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportSF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportSF = New CrystalReportSF()
        rpt.Site = Me.Site
        Return rpt
    End Function
