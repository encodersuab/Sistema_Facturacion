Public Class frmFACTURA_CAMPOFERIAL
    ...
    End Sub
    Private Sub frmFACTURA_CAMPOFERIAL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        mostrar()
    End Sub
    ...
    Private Sub btnReImpreisionFactura_Click(sender As Object, e As EventArgs) Handles btnReImpreisionFactura.Click
        frmFactura2.txtnumfactura.Text = txtIDCodQr.Text
