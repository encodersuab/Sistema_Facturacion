Public Class frmCategoriaCAMPOFERIAL
    ...
    Private Sub datalistado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellDoubleClick
        If txtflag.Text = "1" Then
            frmProductoCAMPOFERIAL.txtidcategoria.Text = datalistado.SelectedCells.Item(1).Value
            frmProductoCAMPOFERIAL.txtnom_categoria.Text = datalistado.SelectedCells.Item(2).Value
            Me.Close()
