Public Class frmClienteCAMPOFERIAL

    Private dt As New DataTable
    Private Sub frmClienteCAMPOFERIAL_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        mostrar()
    End Sub
    ...
    Private Sub datalistado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellDoubleClick
        If txtFlag.Text = "1" Then
            frmVentaCAMPOFERIAL.txtidCliente.Text = datalistado.SelectedCells.Item(1).Value
            frmVentaCAMPOFERIAL.txtNombreCLiente.Text = datalistado.SelectedCells.Item(2).Value
            frmVentaCAMPOFERIAL.txtNumDoc.Text = datalistado.SelectedCells.Item(6).Value
            frmVentaCAMPOFERIAL.txtNombreFac.Text = datalistado.SelectedCells.Item(2).Value + " " + datalistado.SelectedCells.Item(3).Value
            txtFlag.Text = "0"
            Me.Close()

        ElseIf txtFlag.Text = "2" Then
            frmVentaPlanillaCAMPOFERIAL.txtidCliente.Text = datalistado.SelectedCells.Item(1).Value
            frmVentaPlanillaCAMPOFERIAL.txtNombreCLiente.Text = datalistado.SelectedCells.Item(2).Value
            frmVentaPlanillaCAMPOFERIAL.txtNumDoc.Text = datalistado.SelectedCells.Item(6).Value
            frmVentaPlanillaCAMPOFERIAL.txtNombreFac.Text = datalistado.SelectedCells.Item(2).Value + " " + datalistado.SelectedCells.Item(3).Value
            txtFlag.Text = "0"
            Me.Close()
        End If
