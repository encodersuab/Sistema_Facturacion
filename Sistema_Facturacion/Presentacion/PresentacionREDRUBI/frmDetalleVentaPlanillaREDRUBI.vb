...
Public Class frmDetalleVentaPlanillaREDRUBI
        ...
        Else
            If Me.ValidateChildren = True And txtIdProducto.Text <> "" And lbCantidad.Text <> "" And txtPrecioUnitario.Text <> "" Then
                ...
                Try
                    ...
                    dtsp.gcantidad = lbCantidad.Text
    ...
    Private Sub txtCantidad_ValueChanged(sender As Object, e As EventArgs)
        'Dim cant As Double
        'cant = lbCantidadCantidad.Text
        'If lbCantidadCantidad.Text > txtStock.Value Then
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        frmReporteRecibo.txtidventa.Text = Me.txtIdVenta.Text
        frmReporteRecibo.MdiParent = frmInicioF
        frmReporteRecibo.Show()
        Me.Close()
        ...
        If result = DialogResult.OK Then
            If Me.ValidateChildren = True And txtIdVenta.Text <> "" Then
                Try
                    ...
                    Dim dts1 As New vDetalleVentaREDRUBI
                    Dim func1 As New fDetalleVentaREDRUBI
                    Dim dts2 As New vDetalleVentaREDRUBI
                    Dim func2 As New fDetalleVentaREDRUBI
                    Dim dts3 As New vVentaREDRUBI
                    Dim func3 As New fVentaREDRUBI
    ...
    Private Sub lbCantidad_Click(sender As Object, e As EventArgs) Handles lbCantidad.Click
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Else
            btnGuardar.Visible = 1
            lbCantidad.Text = Double.Parse(lbCantidad.Text) + 1
