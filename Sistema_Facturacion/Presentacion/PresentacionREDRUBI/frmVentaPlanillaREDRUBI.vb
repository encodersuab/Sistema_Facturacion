Public Class frmVentaPlanillaREDRUBI
    Private dt As New DataTable
    Private Sub frmVentaPlanillaREDRUBI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub mostrarVentaPlanilla()
        Try
            Dim func As New fVentaPlanillaREDRUBI
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        If Me.ValidateChildren = True And txtidCliente.Text <> "" And txtNombreCLiente.Text <> "" And txtNumDoc.Text <> "" Then
            Try
                Dim dts As New vVentaPlanillaREDRUBI
                Dim func As New fVentaPlanillaREDRUBI
    ...
    Private Sub cargar_detalle_factura()
        ...
        frmDetalleVentaREDRUBI.txtDD.Text = 1
    ...
    Private Sub cargar_detalle()
        ...
        frmDetalleVentaplanillaREDRUBI.txtidCliente.Text = datalistado.SelectedCells.Item(2).Value
        frmDetalleVentaplanillaREDRUBI.txtIdVenta.Text = datalistado.SelectedCells.Item(1).Value
        frmDetalleVentaplanillaREDRUBI.txtNombreCLiente.Text = datalistado.SelectedCells.Item(3).Value
        frmDetalleVentaplanillaREDRUBI.dtpFecha.Text = datalistado.SelectedCells.Item(5).Value
        frmDetalleVentaplanillaREDRUBI.cbTipoDoc.Text = datalistado.SelectedCells.Item(6).Value
        frmDetalleVentaplanillaREDRUBI.txtNumDoc.Text = datalistado.SelectedCells.Item(7).Value
        frmDetalleVentaplanillaREDRUBI.txtNombreFac.Text = datalistado.SelectedCells.Item(8).Value

        frmDetalleVentaplanillaREDRUBI.ShowDialog()
    ...
    Private Sub btnBuscarCliente_Click(sender As Object, e As EventArgs) Handles btnBuscarCliente.Click
        frmClienteREDRUBI.txtFlag.Text = "2"
