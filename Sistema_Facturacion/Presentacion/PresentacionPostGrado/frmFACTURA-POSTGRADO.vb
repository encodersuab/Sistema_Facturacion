Public Class frmFACTURA_POSTGRADO
    ...
    End Sub
    Private Sub frmFACTURA_POSTGRADO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        mostrar()
    End Sub
            ...
            If Me.ValidateChildren = True And txtIDCodQr.Text <> "" And txtNit_Emisor.Text <> "" And txtNum_Factura.Text <> "" And txtINum_Autorizacion.Text <> "" And txtfechaEmision.Text <> "" And txtTotalPagar.Text <> "" And txtCodigoControl.Text <> "" And txtCiNitComprador.Text <> "" Then
                Try
                    ...
                    If (res = Windows.Forms.DialogResult.Yes) Then
                        func.editar3(dts)
                        Do While func1.mostraridprodXidventa3(dts1) <> 0

                            dts2.gidproducto = func1.mostraridprodXidventa3(dts1)
                            dts2.gcantidad = func1.mostrarCantidadXidventa3(dts1)
                            func2.aumentar_stock3(dts2)
                            dts2.giddedatlle_venta = func1.mostrariddetalleventaXidventa3(dts1)
                            dts2.gvalidez = "A"
                            func2.editarValidez3(dts2)
                            ' func1.eliminar(dts2)
                        Loop
                        mostrar()
                        limpiar()
    ...
    Private Sub btnReImpreisionFactura_Click(sender As Object, e As EventArgs) Handles btnReImpreisionFactura.Click
        frmFactura3.txtnumfactura.Text = txtIDCodQr.Text
