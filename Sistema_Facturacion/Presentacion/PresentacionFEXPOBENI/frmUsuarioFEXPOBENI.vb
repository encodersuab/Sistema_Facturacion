Public Class frmUsuarioFEXPOBENI
    Private dt As New DataTable
    Private Sub frmUsuario_LoadFEXPOBENI(sender As Object, e As EventArgs) Handles MyBase.Load
        mostrar()
    ...
    Private Sub mostrar()
        Try
            Dim func As New fUsuarioFEXPOBENI
            dt = func.mostrar
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        If Me.ValidateChildren = True And txtNombre.Text <> "" And txtApellido.Text <> "" And txtDireccion.Text <> "" And txtTelefono.Text <> "" And txtCi.Text <> "" And txtLogin.Text <> "" And txtContraceña.Text <> "" And txtAcceso.Text <> "" And txtRol.Text <> "" Then
            Try
                Dim dts As New vUsuarioFEXPOBENI
                Dim func As New fUsuarioFEXPOBENI
