Public Class frmCategoriaFEXPOBENI
    Private dt As New DataTable
    Private Sub GroupBox2_Enter(sender As Object, e As EventArgs) Handles GroupBox2.Enter

    End Sub

    Private Sub frmCategoria_LoadFEXPOBENI(sender As Object, e As EventArgs) Handles MyBase.Load
        mostrar()
    End Sub
    ...
    Private Sub mostrar()
        Try
            Dim func As New fCategoriaFEXPOBENI
            dt = func.mostrar
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        If Me.ValidateChildren = True And txtNombre.Text <> "" Then
            Try
                Dim dts As New vCategoriaFEXPOBENI
                Dim func As New fCategoriaFEXPOBENI
    ...
    Private Sub datalistado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles datalistado.CellDoubleClick
        If txtflag.Text = "1" Then
            frmProductoFEXPOBENI.txtidcategoria.Text = datalistado.SelectedCells.Item(1).Value
            frmProductoFEXPOBENI.txtnom_categoria.Text = datalistado.SelectedCells.Item(2).Value
            Me.Close()
