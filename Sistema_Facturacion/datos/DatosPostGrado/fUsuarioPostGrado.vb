...
Public Class fUsuarioPostGrado
    Inherits Conexion
    Dim cmd As New SqlCommand

    Public Function validar_usuario(ByVal dts As vUsuarioPostGrado)
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function mostrar_rol(ByVal dts As vUsuarioPostGrado)
        Try
            conectado()
            cmd = New SqlCommand("validar_usuario")
            cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function mostrarROL(ByVal dts As vUsuarioPostGrado)
    ...
    Public Function insertar(ByVal dts As vUsuarioPostGrado) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vUsuarioPostGrado) As Boolean
        Try
            conectado()
