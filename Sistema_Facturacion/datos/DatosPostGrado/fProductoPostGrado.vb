...
Public Class fProductoPostGrado
    ...
    Public Function insertar(ByVal dts As vProductoPostGrado) As Boolean
        Try
            conectado()
    ...
    Public Function editar(ByVal dts As vProductoPostGrado) As Boolean
        Try
            conectado()
