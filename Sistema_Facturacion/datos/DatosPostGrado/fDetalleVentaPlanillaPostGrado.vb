...
Public Class fDetalleVentaPlanillaPostGrado
    Inherits Conexion
    ...
    Public Function eliminar(ByVal dts As vDetalleVentaPlanillaPostGrado) As Boolean
        Try
            conectado()
    ...
    Public Function eliminarproductoVenta(ByVal dts As vDetalleVentaPlanillaPostGrado) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function aumentar_stock(ByVal dts As vDetalleVentaPlanillaPostGrado) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function disminuir_stock(ByVal dts As vDetalleVentaPlanillaPostGrado) As Boolean
        Try
            conectado()
