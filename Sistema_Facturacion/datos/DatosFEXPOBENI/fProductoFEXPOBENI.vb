...
Public Class fProductoFEXPOBENI
    ...
    Public Function insertar(ByVal dts As vProductoFEXPOBENI) As Boolean
        Try
            conectado()
    ...
    Public Function editar(ByVal dts As vProductoFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function eliminar(ByVal dts As vProductoFEXPOBENI) As Boolean
        Try
            conectado()
