...
Public Class fUsuarioFEXPOBENI
    Inherits Conexion
    Dim cmd As New SqlCommand

    Public Function validar_usuario(ByVal dts As vUsuarioFEXPOBENI)
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function mostrar_rol(ByVal dts As vUsuarioFEXPOBENI)
        Try
            conectado()
            cmd = New SqlCommand("validar_usuario")
            cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function mostrarROL(ByVal dts As vUsuarioFEXPOBENI)
    ...
    Public Function insertar(ByVal dts As vUsuarioFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vUsuarioFEXPOBENI) As Boolean
        Try
            conectado()
