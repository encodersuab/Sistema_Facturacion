...
Public Class fCategoriaFEXPOBENI
    Inherits Conexion
    ...
    Public Function insertar(ByVal dts As vCategoriaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vCategoriaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function eliminar(ByVal dts As vCategoriaFEXPOBENI) As Boolean
        Try
            conectado()
