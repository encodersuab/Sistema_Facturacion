...
Public Class fVentaFEXPOBENI
    ...
    Public Function insertar(ByVal dts As vVentaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vVentaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function eliminar(ByVal dts As vVentaFEXPOBENI) As Boolean
        Try
            conectado()
