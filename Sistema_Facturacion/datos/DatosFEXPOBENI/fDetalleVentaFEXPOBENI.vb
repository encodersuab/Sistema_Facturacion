...
Public Class fDetalleVentaFEXPOBENI
    Inherits Conexion
    ...
    Public Function insertar(ByVal dts As vDetalleVentaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vDetalleVentaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function eliminar(ByVal dts As vDetalleVentaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function aumentar_stock(ByVal dts As vDetalleVentaFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function disminuir_stock(ByVal dts As vDetalleVentaFEXPOBENI) As Boolean
        Try
            conectado()
