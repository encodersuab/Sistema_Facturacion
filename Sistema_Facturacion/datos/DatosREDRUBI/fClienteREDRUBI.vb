...
Public Class fClienteREDRUBI
    ...
    Public Function insertar(ByVal dts As vClienteREDRUBI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vClienteREDRUBI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function eliminar(ByVal dts As vClienteREDRUBI) As Boolean
        Try
            conectado()
