...
Public Class fDetalleVentaREDRUBI
    ...
    Public Function insertar(ByVal dts As vDetalleVentaREDRUBI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vDetalleVentaREDRUBI) As Boolean
        Try
            conectado()
    ...
    Public Function eliminar(ByVal dts As vDetalleVentaREDRUBI) As Boolean
        ...
        End Try
    End Function
    Public Function aumentar_stock(ByVal dts As vDetalleVentaREDRUBI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function disminuir_stock(ByVal dts As vDetalleVentaREDRUBI) As Boolean
        Try
            conectado()
