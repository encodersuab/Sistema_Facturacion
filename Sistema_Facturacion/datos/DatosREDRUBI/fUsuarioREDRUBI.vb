...
Public Class fUsuarioREDRUBI
    ...
    Public Function validar_usuario(ByVal dts As vUsuario)
        ...
        End Try
    End Function
    Public Function mostrar_rol(ByVal dts As vUsuarioREDRUBI)
        Try
            conectado()
            cmd = New SqlCommand("validar_usuario")
            cmd.CommandType = CommandType.StoredProcedure
    ...
    Public Function mostrarROL(ByVal dts As vUsuarioREDRUBI)
    ...
    Public Function insertar(ByVal dts As vUsuarioREDRUBI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vUsuarioREDRUBI) As Boolean
        Try
            conectado()
