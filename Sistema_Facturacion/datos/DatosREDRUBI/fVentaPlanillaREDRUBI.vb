...
Public Class fVentaPlanillaREDRUBI
    Inherits Conexion
    ...
    Public Function insertarventaPlanilla(ByVal dts As vVentaPlanillaREDRUBI) As Boolean
        Try
            conectado()
    ...
    Public Function editarVentaPlanilla(ByVal dts As vVentaPlanillaREDRUBI) As Boolean
        Try
            conectado()
    ...
    Public Function eliminarventaPlanilla(ByVal dts As vVentaPlanillaREDRUBI) As Boolean
        Try
            conectado()
