...
Public Class fProductoREDRUBI
    ...
    Public Function mostrar() As DataTable
        Try
            conectado()
            cmd = New SqlCommand("mostrar_producto_redrubi")
    ...
    Public Function insertar(ByVal dts As vProductoREDRUBI) As Boolean
        Try
            conectado()
    ...
    Public Function editar(ByVal dts As vProductoREDRUBI) As Boolean
        Try
            conectado()
