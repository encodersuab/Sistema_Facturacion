...
Public Class fClienteFEXPOBENI
    Inherits Conexion
    ...
    Public Function insertar(ByVal dts As vClienteFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function editar(ByVal dts As vClienteFEXPOBENI) As Boolean
        Try
            conectado()
        ...
        End Try
    End Function
    Public Function eliminar(ByVal dts As vClienteFEXPOBENI) As Boolean
        Try
            conectado()
